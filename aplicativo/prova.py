    ...
    while cap.isOpened():
        ...
        try:
            for face_landmarks in saida_facemesh.multi_face_landmarks:
                ...
                cv2.putText(frame, f"MAR: {round(mar, 2)} { 'abriu a boca' if mar>mar_boca_berta else  'fechou a boca '}", (1, 50),
                            cv2.FONT_HERSHEY_DUPLEX,
                            0.9, (0, 255, 255), 2)
                if mar>mar_boca_berta and boca_aberta==0:
                    boca_aberta=1
                    pygame.mixer.music.play(-1) 
                    
                elif mar<mar_boca_berta:
                    boca_aberta=0
